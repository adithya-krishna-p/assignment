...
const Widget2 = () => {
  ...
  return (
    <>
      ...
      <div className="w-[720px] h-[350px] mt-1 p-5 pt-6 mx-auto  mr-[40px]  bg-gray-700 text-white rounded-lg shadow-2xl shadow-black border-1 ">
       ...
       <div className=' flex  flex-col   '>
        ...
        <div className="flex ml-12 justify-between   ">
          <button className="bg-black w-[149px] h-[62px] text-white px-4  rounded-lg  ">Gallery</button>
          <input
            type="file"
            accept="image/*"
            className="hidden"
          ...
          <label
            htmlFor="imageUpload"
            className="bg-gray-700 px-4 py-2 h-[46px] w-[131px] absolute  rounded-full  shadow-xl shadow-black ml-80  cursor-pointer"
          >+ Add image</label>

          <div className=' flex justify-end flex-row gap-4 mr-10 '>
          <img className='h-[45px] w-[45px] shadow-xl shadow-black  rounded-full' src={icon3}></img>
          <img className='h-[45px] w-[45px] shadow-xl shadow-black  rounded-full' src={icon4}></img>
         </div>
        </div>
       </div>
